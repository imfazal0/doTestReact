  ...
  return (
    <div className='md:w-[30%] md:h-1/2 h-[30vh] w-full flex flex-col  bg-gray-200 rounded-2xl mt-5 py-[3%] md:py-[1%]  px-[2%]'>
        ...
        <div className='h-1/5 w-full flex flex-row items-center gap-x-2 ' >
            ...
            <button onClick={handleReview} className='w-1/2 h-9/12 border border-gray-300 bg-gray-100 font-bold text-purple-700 md:rounded-xl rounded-md flex items-center justify-center hover:bg-gray-200 hover:shadow-2xl transition-all  '>Review</button>
            <button  className='w-1/2 h-9/12 border-0 border-gray-300 bg-purple-700 font-bold text-white md:rounded-xl rounded-md flex items-center justify-center  hover:bg-purple-900 hover:shadow-2xl transition-all '>Retake</button>
