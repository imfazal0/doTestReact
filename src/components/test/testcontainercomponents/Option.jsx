...
const Option = ({opt,setCheckedOpt ,  idx ,checkedOpt,qidx}) => {
  ...
  return (
    <div className={check? style+'check' : style+'optShadow'} >
        ...
        <div className='md:w-[10%] w-1/5 aspect-square bg-gray-300 md:rounded-xl rounded-sm font-extrabold text-gray-500 flex items-center justify-center md:text-xl'>{qidx}</div>
